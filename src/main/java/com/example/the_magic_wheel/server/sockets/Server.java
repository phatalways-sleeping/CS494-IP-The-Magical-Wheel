...
public class Server extends Component implements Runnable {
    ...
    public Map<String, SocketChannel> getClients() {
        return clients;
    }
    ...
    public static void stop(ServerConfiguration configuration) {
    ...
    // client.close();
    // } catch (IOException e) {
    // System.err.println("Server: Failed to close the connection with " +
